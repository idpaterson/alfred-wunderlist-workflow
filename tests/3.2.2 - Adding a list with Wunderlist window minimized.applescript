...
set precondition to "Press Cmd+M in Wunderlist to minimize the main window, then activate a different app on the same desktop before pressing Go. Wunderlist should be running on the same desktop but with no visible windows."
