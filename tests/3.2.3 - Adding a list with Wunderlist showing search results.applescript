...
set precondition to "Press Cmd+F in Wunderlist to search, then type 'sample' as the search term. Do not press return. Wunderlist should be running on the current desktop."
