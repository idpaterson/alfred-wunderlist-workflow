...
**Test 1.3.3 –** `wl` task that is a substring of a list name by selecting the list <a name="1.3.3"></a>

|                    Action                    | Alfred Query |               Alfred Results              |           Wunderlist          |
| -------------------------------------------- | ------------ | ----------------------------------------- | ----------------------------- |
| Type `wl o` in Alfred                        | `wl o`       | *Inbox*, *Today* and other matching lists | —                             |
| Press *down arrow* until *Today* is selected | `wl o`       | Same lists with *Today* selected          | —                             |
| Press *return*                               | —            | —                                         | New task *o* added in *Today* |
...
|                Action               |    Alfred Query    | Alfred Results |          Wunderlist          |
| ----------------------------------- | ------------------ | -------------- | ---------------------------- |
| Type `wllist Sample list` in Alfred | `wlin Sample list` | New list       | —                            |
...
|                    Action                    |         Alfred Query        | Alfred Results |               Wunderlist              |
| -------------------------------------------- | --------------------------- | -------------- | ------------------------------------- |
| Type `wllist Sámple \/][;$ "list"` in Alfred | `wlin Sámple \/][;$ "list"` | New list       | —                                     |
...
- [ ] **Test 1.3.3 –** `wl` task that is a substring of a list name by selecting the list
